...
<body>
    <nav class="navbar navbar-expand-lg navbar-light  bg-white border-bottom border-5 border-warning">
        <div class="container-fluid">
            ...
            <a class="navbar-brand fs-4" href="#">Administrator</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav d-lg-none ms-auto text-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/controller">Admin Controller</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="offcanvas offcanvas-start sidebar-nav" tabindex="-1" data-bs-backdrop="false" id="offcanvasExample"
        ...
        <div class="offcanvas-body d-flex flex-column flex-shrink-0 p-3 bg-white" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="/admin/dashboard" class="nav-link active text-center mb-4" aria-current="page">
                ...
                <li>
                    <a href="/admin/controller" class="ms-3 nav-link link-dark">
                        <i class="bi bi-gear-fill me-2"></i>
                        Admin Controller
                    </a>
                </li>
                <li>
                    <a href="/admin/create" class="ms-3 nav-link link-dark">
                        <i class="bi bi-send-plus-fill me-2"></i>
                        Aspirasi Create
                    </a>
                </li>
                <li>
                    <a href="/admin/users" class="ms-3 nav-link link-dark">
    ...
    <div class="container mt-4 fw-bold border-bottom border-2 fs-5 border-5 border-bottom">
        <a class="text-decoration-none" href="">Home</a>> Dashboard
    </div>
